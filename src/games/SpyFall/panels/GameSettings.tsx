import { Button, CardGrid, Cell, CellButton, Div, Group, Header, IOS,
  NativeSelect, Panel, PanelHeader, PanelHeaderButton, platform } from '@vkontakte/vkui';
  ...
  return <Panel id={props.id}>
    ...
    <Group>
      ...
      <Group>
        ...
        <CardGrid size="m">
          {collections.map((item) => <ListItemComponent
            key={'collection' + item.id} item={item}
