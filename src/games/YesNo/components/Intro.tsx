...
export const Intro = (props: Props) => (
  <Div>
    ...
    <Group separator="hide"><Button onClick={() => props.setViewType(YesNoViewTypes.LIST_VIEW)} stretched mode="secondary" size="l">{lang('games_yesno_list_of_yesno')}</Button></Group>
    <Group separator="hide"><Button onClick={() => props.openYesNo(shuffleArray(props.yesNoBase)[0])} stretched mode="secondary" size="l">{lang('games_yesno_rand_yesno')}</Button></Group>
  </Div>
)
